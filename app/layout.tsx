...
export const metadata = {
  title: 'Eduardo | Personal Portfolio',
  description: 'Eduardo Cintra is a full-stack developer with a 5 years of experience.',
}
      ...
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative 
       pt-28 sm:pt-36`}>
        ...
        <div className='bg-[#dbd7fb] absolute top [-1rem] -z-10 left-[-35rem] 
          h-[50rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]
