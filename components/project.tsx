...
export default function Project({ title, description, tags, imageUrl }: ProjectProps ) {
    ...
    return (
        <motion.div
            ...
            className='group mb-3 s:mb-8 last:mb-0'
        >
            <section 
            className='b-gray-100 max-2-[42rem] border border-black/5 
            overflow-hidden sm:pr-8 relative sm:h-[20rem] sm:group:even:pl-8 
            hover:bg-gray-200 transition rounded-lg dark:text-white dark:bg-white/20'>
            ...
            <Image 
                ...
                group-hover:scale-[1.07] group-hover:-translate-x-3
